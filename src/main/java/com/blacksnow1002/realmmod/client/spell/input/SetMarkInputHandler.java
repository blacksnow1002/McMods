...
import com.blacksnow1002.realmmod.system.spell.network.C2S.SetMarkPacket;
...
public class SetMarkInputHandler {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        if (ModKeyBindings.SET_MARK_SPELL_KEY.isDown()) {
            ModMessages.sendToServer(new SetMarkPacket(0));
        }
    }
}
