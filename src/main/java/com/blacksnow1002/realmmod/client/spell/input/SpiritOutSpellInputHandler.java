...
import com.blacksnow1002.realmmod.system.spell.network.C2S.SpiritOutPacket;
...
public class SpiritOutSpellInputHandler {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        if (ModKeyBindings.SPIRIT_OUT_KEY.consumeClick()) {
            ModMessages.sendToServer(new SpiritOutPacket(0));
        }
    }
}
