...
import com.blacksnow1002.realmmod.system.spell.network.C2S.GiantSpellPacket;
...
public class GiantInputHandler {
    ...
    public static void onKeyInput(InputEvent.Key event) {
        ...
        if (ModKeyBindings.GIANT_SPELL_KEY.consumeClick()) {
            ModMessages.sendToServer(new GiantSpellPacket(0));
        }
    }
}
